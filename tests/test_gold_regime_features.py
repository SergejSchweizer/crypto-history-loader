        ...
        rows=[
            {
                ...
                "rv_4h": 23.0 + index,
                "rv_1d": 24.0 + index,
                "rv_5m_annualized_pct": 220.0 + index,
                "rv_15m_annualized_pct": 210.0 + index,
                "rv_1h_annualized_pct": 200.0 + index,
                "rv_4h_annualized_pct": 190.0 + index,
                "rv_1d_annualized_pct": 180.0 + index,
                "rv_30d": 25.0 + index,
