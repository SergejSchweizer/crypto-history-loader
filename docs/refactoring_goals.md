...
|---|---:|---|
| `application/services/fetch_service.py` | 1,864 lines | Fetch planning, task execution, retries, and reporting remain coupled after trade-window and task-callback extraction. |
