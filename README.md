...
- GitHub Actions runs lint/docs/config checks, typing checks, unit-test shards, and integration-test shards
  as independent parallel gates. Unit and integration tests each use four deterministic test-file shards.
