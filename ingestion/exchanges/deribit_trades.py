"""Compatibility aliases for the Deribit perp_trades adapter."""

from __future__ import annotations

from collections.abc import Callable

from ingestion.exchanges.deribit_perp_trades import (
    ...
    fetch_perp_trades_all,
    fetch_perp_trades_range,
)
...
def fetch_trades_range(
    *,
    ...
    """Fetch Deribit perp_trades, preserving the previous generic function name."""

    return fetch_perp_trades_range(
        symbol=symbol,
        market=market,
...
def fetch_trades_all(
    *,
    ...
    """Fetch all Deribit perp_trades, preserving the previous generic function name."""

    return fetch_perp_trades_all(symbol=symbol, market=market, on_page=on_page)
