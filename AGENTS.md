...
Applies to release readiness and repository-wide instruction consistency.

## Rules

- [MUST] `AGENTS.md` is the standalone source of truth for repository instructions.
- [MUST] Durable repository instruction changes must be made directly in `AGENTS.md`.
- [MUST] Do not add hooks or automation that overwrite or synchronize `AGENTS.md` from an external source.
...
- `AGENTS.md` is maintained as a standalone repository policy.
- Hooks and automation do not overwrite repository instructions.
